...
const Create = customer => {
    ...
    if (!customer.password) error.password = "Password is required"
    if (customer.password && customer.password.length <= 8) error.name = "Name must be greater than 8 character"
...
const CreateByAdmin = customer => {
    ...
    if (!customer.password) error.password = "Password is required"
    if (customer.password && customer.password.length < 8) error.password = "Password must be greater than 8 character"
